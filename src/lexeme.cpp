...
Termsequel::LexemeType::LexemeType(const Termsequel::LexemeKey lexeme_key,
                                   std::string name)
...
Termsequel::Lexeme::Lexeme(const LexemeType &lexeme_type)
    : lexeme_type(lexeme_type){};

Termsequel::Lexeme::Lexeme(const LexemeType &lexeme_type,
                           const std::string value)
    : lexeme_type(lexeme_type), value(std::make_shared<std::string>(value)){};
...
LexemeType const LexemeType::OWNER_PERMISSIONS(LexemeKey::COLUMN,
                                               "OWNER_PERMISSIONS");
#ifdef __linux__
LexemeType const LexemeType::GROUP_PERMISSIONS(LexemeKey::COLUMN,
                                               "GROUP_PERMISSIONS");
...
LexemeType const LexemeType::NOT_STARTS_WITH(LexemeKey::COMPARASION,
                                             "NOT_STARTS_WITH");
LexemeType const LexemeType::ENDS_WITH(LexemeKey::COMPARASION, "ENDS_WITH");
LexemeType const LexemeType::NOT_ENDS_WITH(LexemeKey::COMPARASION,
                                           "NOT_ENDS_WITH");
LexemeType const LexemeType::CONTAINS(LexemeKey::COMPARASION, "CONTAINS");
LexemeType const LexemeType::NOT_CONTAINS(LexemeKey::COMPARASION,
                                          "NOT_CONTAINS");
...
LexemeType const LexemeType::BIGGER_OR_EQUAL(LexemeKey::COMPARASION,
                                             "BIGGER_OR_EQUAL");
LexemeType const LexemeType::LESS_OR_EQUAL(LexemeKey::COMPARASION,
                                           "LESS_OR_EQUAL");
